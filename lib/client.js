...
var STYLE_ID = "dsh-sidebar-explorer-plus-style";
...
function UploadView(props) {
  ...
  const reload = (0, import_react.useCallback)(() => {
    ...
    const dirs = /* @__PURE__ */ new Set([root, ...expanded]);
  ...
  const handleDrop = (0, import_react.useCallback)((event) => {
    ...
    collectDroppedFiles(dataTransfer).then((files) => {
      ...
      return Promise.all(workers).then(() => {
        ...
        if (targetDir !== void 0 && targetDir !== root) {
  ...
  const renderLevel = (dir, depth) => {
    ...
    if (level === void 0) {
      return [(0, import_react.createElement)("div", { key: `${dir}:loading`, className: "dse-empty" }, label("\u52A0\u8F7D\u4E2D\u2026", "Loading\u2026"))];
    }
    if (level.error !== void 0) {
      return [(0, import_react.createElement)("div", { key: `${dir}:error`, className: "dse-empty dse-error" }, level.error)];
    }
  ...
  if (sessionId === "") {
    return (0, import_react.createElement)(
      "div",
      { className: "dse-root" },
      (0, import_react.createElement)("div", { className: "dse-empty" }, label("\u9009\u62E9\u4E00\u4E2A\u4F1A\u8BDD\u4EE5\u4F7F\u7528\u6587\u4EF6\u7BA1\u7406", "Select a conversation to manage files"))
    );
  }
  const children = [];
  if (targetDir !== void 0) {
  ...
  if (root !== void 0) {
    ...
    children.push((0, import_react.createElement)(
      ...
      (0, import_react.createElement)(
        ...
        folderIcon(),
        (0, import_react.createElement)("button", { className: "dse-name", type: "button", title: root, onClick: () => setSelected(root) }, baseName(root))
      ),
      ...renderLevel(root, 1)
    ));
  }
  children.push((0, import_react.createElement)(
    ...
    (0, import_react.createElement)(
      "svg",
      { className: "dse-icon", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true" },
    ...
    (0, import_react.createElement)("div", { className: "dse-title" }, label("\u5C06\u6587\u4EF6\u6216\u6587\u4EF6\u5939\u62D6\u5230\u6B64\u5904\u4E0A\u4F20", "Drop files or folders here to upload")),
    (0, import_react.createElement)("div", { className: "dse-sub" }, label("\u62D6\u5230\u4E0A\u65B9\u6587\u4EF6\u5939\u53EF\u79FB\u52A8\uFF1B\u53F3\u952E\u53EF\u91CD\u547D\u540D / \u5220\u9664", "Drag onto a folder to move; right-click to rename / delete"))
  ));
  if (busy && progress) {
    ...
    children.push((0, import_react.createElement)(
      "div",
      { className: "dse-bar" },
      (0, import_react.createElement)("div", { className: "dse-bar-fill", style: { width: `${percent}%` } })
    ));
    children.push((0, import_react.createElement)(
      "p",
      { className: "dse-status" },
  ...
  if (result) {
    ...
    children.push((0, import_react.createElement)("p", { className: "dse-status" }, line));
    if (result.failed.length > 0) {
      const items = result.failed.slice(0, 20).map((name) => (0, import_react.createElement)("li", { key: name }, name));
      children.push((0, import_react.createElement)("ul", { className: "dse-list" }, items));
    }
  }
  if (error) {
    children.push((0, import_react.createElement)("p", { className: "dse-status dse-error" }, error));
  }
  if (menu !== null) {
    const menuItems = [];
    if (menu.isDir) {
  ...
  return (0, import_react.createElement)("div", { className: "dse-root" }, children);
}
